...
def advanced_settings():
	selection = xbmcgui.Dialog().select('Selecteer hoeveel Ram uw systeem heeft.', ['1GB (1st - 3rd gen, Lite Firestick)','1GB tot 1.5GB (4k Firestick)','1.5GB tot 2GB (Firebox, Cube, Sheild Tube)','2GB tot 3GB RAM','3GB of meer (Nvidia Shield Pro)','Verwijder Advanced instellingen'])
	if selection==0:
